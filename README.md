...
- `community_safety.py`: 기본 allowlist는 보수적으로 운영하며 고위험 커뮤니티 표현과 개인 투자 인증형 데이터를 제거합니다.
...
- `COMMUNITY_ENABLED_SOURCES`
  - 기본값: `stockplus_insight,reddit_wallstreetbets`
  - 선택 추가: `blind_stock_lounge`, `dc_stock_gallery`, `naver_board`
