...
- **`review-driven-execution`**: PM/TPM/기획/시니어개발/개발/품질/신입/운영/주식전문가 멀티롤 리뷰, 계획서 작성, 병렬 스트림 분리, 중간 로그 기록 후 구현하는 스킬
...
- 사용자가 큰 작업을 요청하거나 요구사항이 엮여 있으면, 기본적으로 **PM / TPM / 기획자 / 시니어 개발자 / 개발자 / 품질 담당자 / 신입개발자 / 운영자 / 주식 전문가** 관점 리뷰를 먼저 수행합니다.
- 역할별 기본 책임은 아래와 같이 통일합니다.
  - PM: 사용자 가치, 범위, 우선순위
  - TPM: 런타임/의존성/배포 리스크
  - 기획자: 정보 구조, UX, 수용 기준
...
- PR 본문: 아래 9개 관점 리뷰 섹션 필수
  - PM / TPM / 기획자 / 시니어 개발자 / 개발자 / 품질 담당자 / 신입개발자 / 운영자 / 주식 전문가
- 리뷰 정책:
...
5. PR 생성 (`gh pr create --body-file`) + 9개 역할 리뷰 섹션 작성
